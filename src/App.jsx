...
const App = () => {
  return (
    <div className="div-container">
      <NavBar />
      <CarouselMovies movies={movies} categorieMovies={actionMovies} />
      <CarouselMovies movies={movies} categorieMovies={terrorMovies} />
      <CarouselMovies movies={movies} categorieMovies={comedyMovies} />
    </div>
  );
};
